// ==============================================
// KÄYTTÖLIITTYMÄN RENDERÖINTI (js/ui.js)
// ==============================================
...
// ==============================================
// APUFUNKTIOT MODAALEILLE JA ILMOITUKSILLE
// ==============================================
...
window.generateCardHTML = function(cDef, isLocked = false, extraBottomHtml = '', isCarousel = false) {
    ...
    // Hae playCost globaalista funktiosta, jos se on olemassa, muuten aseta kovakoodattu arvo
    let playCost = 0;
...
// ==============================================
// TAULUN PIIRTÄMINEN (Kansio, Automaatti, Kuitit)
// ==============================================
...
// ==============================================
// KARUSELLI (Kortin tarkastelu ja pelaaminen)
// ==============================================
